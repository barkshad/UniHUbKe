          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/listings" className="text-sm text-white/50 hover:text-white transition-colors">Find Housing</Link></li>
                <li><Link to="/admin" className="text-sm text-white/50 hover:text-white transition-colors">Landlord Portal</Link></li>
              </ul>
            </div>
